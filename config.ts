...
export const STORE_CONFIG = {
  IS_MAINTENANCE: false, // Altere para false para reativar o cardápio
  COLORS: {
    primary: '#5C3D2E',
    secondary: '#E89E7D',
    background: '#FDF1EB',
  ...
  DELIVERY_FEE: 6.00,
  PIX_CODE: '00020126360014br.gov.bcb.pix0114+55859841537805204000053039865802BR5911SORA50679376009Sao Paulo610901227-20062230519daqr49730549472216463043E09',
  CONTACT_PHONE: '5585996269684',
  MENU_ITEMS: [
    // Pastéis
